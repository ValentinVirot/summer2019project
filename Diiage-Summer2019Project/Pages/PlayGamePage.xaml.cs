/*
 * Filename: /Pages/PlayGamePage.xaml.cs
 * Created by: Valentin Virot, @valentin_vir
 * Description: User connection page before select game to play
*/
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (blindtest.connectUser(selected_user.user_id, passwordBox.Password, users_listView.SelectedIndex) == true)
                    {
                        ...
                        this.Frame.Navigate(typeof(Pages.PlayGameSelectionPage), blindtest);
                    }
